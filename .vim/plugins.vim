...
" Required:
set runtimepath+=/home/base/dotfiles/.vim/bundle//repos/github.com/Shougo/dein.vim

" Required:
if dein#load_state('/home/base/dotfiles/.vim/bundle/')
  call dein#begin('/home/base/dotfiles/.vim/bundle/')

  " Let dein manage dein
  " Required:
  call dein#add('/home/base/dotfiles/.vim/bundle//repos/github.com/Shougo/dein.vim')
...
" Custom Plugins Start Here
  ...
  "call dein#add('kien/ctrlp.vim' "unmaintained)
  "call dein#add('ctrlpvim/ctrlp.vim' "maintained Fork)
  ...
  if has('nvim')
    call dein#add('euclio/vim-markdown-composer', {
          \ 'build' : 'cd ~/dotfiles/.vim/bundle/vim-markdown-composer/ && cargo build --release' })
  else
    call dein#add('euclio/vim-markdown-composer', {
          \ 'build' : 'cd ~/dotfiles/.vim/bundle/vim-markdown-composer/ && cargo build --release --no-default-features --features json-rpc' })
  endif
  ...
  call dein#add('marijnh/tern_for_vim', {
      \ 'build' : 'sh -c "(cd ~/.vim/bundle/tern_for_vim; npm install)"'
      \ })
  ...
  call dein#add('scrooloose/syntastic', {
      \ 'build' : 'sh -c "npm install jshint -g"'
      \ })
  ...
  call dein#add('sidorares/node-vim-debugger',{
        \ 'build' : 'npm i vimdebug -g' })


  call dein#add('StanAngeloff/php.vim')


  call dein#add('supermomonga/vimshell-inline-history.vim', 
        \ { 'lazy' : 1, 'depends':['Shougo/vimshell.vim']})

  if dein#tap('vimshell-inline-history.vim') "{{{
  ...
  "i.e. othree/eregex
  call dein#add('Dewdrops/SearchComplete')
  ...
  call dein#add('tecfu/YankRing.vim')
